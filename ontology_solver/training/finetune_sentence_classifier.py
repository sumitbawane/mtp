"""Fine-tune sentence classifier (INITIAL_STATE, TRANSFER, QUESTION).

This script fine-tunes mDeBERTa-v3-base-mnli-xnli for sentence classification.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune sentence classifier")
    parser.add_argument(
        "--train-data",
        type=str,
        default="output/training_data/sentence_classification_train.jsonl",
        help="Path to training data"
    )
    parser.add_argument(
        "--val-data",
        type=str,
        default="output/training_data/sentence_classification_val.jsonl",
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="models/sentence_classifier_finetuned",
    ...
    print("="*80)
    print("SENTENCE CLASSIFIER FINE-TUNING")
    print("="*80)

"""
Legacy Transfer Scenario Generation (Traditional Random Approach)
Original scenario generation system using random generation methods
"""
...
if __name__ == "__main__":
    ...
    print("Generating legacy transfer scenarios...")
    ...
    # Save dataset
    generator.save_dataset(scenarios, "legacy/data/transfer_scenarios.json")

    print("\nLegacy dataset generation complete!")